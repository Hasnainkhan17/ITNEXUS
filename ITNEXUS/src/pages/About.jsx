...
export default function About() {
  useSeo({
    title: 'About',
    description: 'Learn about the mission, values, and engineering team at ITNEXUS - experts in software architecture, cloud platforms, and UX design.'
  });
  ...
  const values = pageContent?.aboutValues || [
    {
      icon: "Compass",
  ...
  return (
    <div className="w-full">
      ...
      <section className="pt-36 pb-20 px-6 lg:px-12 border-b border-slate-200/60 bg-gradient-to-b from-slate-50/50 to-white text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-brand-navy tracking-tight">
            {pageContent?.aboutHeroHeading || "Our Mission & Core Capability"}
          </h1>
          <p className="text-lg text-brand-slate leading-relaxed">
            {pageContent?.aboutHeroParagraph || "ITNEXUS is an elite team of full-stack engineers, cloud architects, and UI/UX designers specialized in building high-throughput systems and dynamic corporate applications."}
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-brand-navy">
              {pageContent?.aboutNarrativeHeading || "Crafting premium solutions for global digital transformations"}
            </h2>
            <p className="text-brand-slate leading-relaxed">
              {pageContent?.aboutNarrativeParagraph1 || "Founded in 2021, ITNEXUS emerged from a simple observation: mid-to-large scale businesses often struggle with fragmented technologies that stall deployment speeds and compromise data security."}
            </p>
            <p className="text-brand-slate leading-relaxed">
              {pageContent?.aboutNarrativeParagraph2 || "Our engineering philosophy is rooted in modularity and performance. By unifying database systems, serverless Cloud architecture, and beautiful responsive interfaces under standard design systems, we help our clients deploy features faster and operate with maximum security."}
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-1">
                <div className="text-4xl font-extrabold text-brand-blue">
                  {pageContent?.aboutStatsCountries || "5+"}
                </div>
              ...
              <div className="space-y-1">
                <div className="text-4xl font-extrabold text-brand-cyan">
                  {pageContent?.aboutStatsClients || "50+"}
                </div>
              ...
              <div className="space-y-1 col-span-2 pt-4 border-t border-slate-200/40">
                <div className="text-4xl font-extrabold text-brand-navy">
                  {pageContent?.aboutStatsTelemetry || "24/7/365"}
                </div>
      ...
      <section className="py-24 px-6 lg:px-12 bg-white text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-navy italic">
            {pageContent?.aboutVisionStatement || `"Software engineering is not about typing code, it's about solving enterprise challenges with absolute reliability."`}
          </h2>
        </div>
      </section>
    </div>
